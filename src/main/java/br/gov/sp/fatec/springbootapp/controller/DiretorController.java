...
import br.gov.sp.fatec.springbootapp.service.ProdutoraServiceProvider;
...
public class DiretorController {
    ...
    public ResponseEntity<Diretor> cadastraNovoDiretor(@RequestBody Diretor diretor,
        ...
        responseHeaders.setLocation(uriComponentsBuilder.path("/diretor/id/" + diretor.getId()).build().toUri());
